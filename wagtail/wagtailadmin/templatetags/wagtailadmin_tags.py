...
from wagtail.wagtailadmin.navigation import get_explorable_root_collection, get_explorable_root_page
from wagtail.wagtailadmin.search import admin_search_areas
from wagtail.wagtailcore import hooks
from wagtail.wagtailcore.models import (
    Collection, CollectionViewRestriction, Page, PageViewRestriction,
    UserCollectionPermissionsProxy, UserPagePermissionsProxy)
